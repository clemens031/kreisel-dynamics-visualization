...
Calculates inertia tensors and principal moments  
Calculates nutation and precession  
Visualizes shape using matplotlib  
Dependencies: Python (sympy, numpy, pandas, matplotlib)

Comments in the code are in German  
This was just a fun learning and visualization project from my 3rd semester. 
